...
const SPEED_UNIT_MAP: Record<SpeedUnit, SpeedUnitConfig> = {
  "m/min": { label: "M/MIN", fromMpm: (v) => v,                  maxSpeed: 120, decimals: 0 },
  "cm/s":  { label: "CM/S",  fromMpm: (v) => v * 100 / 60,      maxSpeed: 200, decimals: 0 },
  "km/h":  { label: "KM/H",  fromMpm: (v) => v * 60 / 1000,     maxSpeed: 8,   decimals: 1 },
  "mph":   { label: "MPH",   fromMpm: (v) => v * 60 / 1609.344, maxSpeed: 5,   decimals: 1 },
};
