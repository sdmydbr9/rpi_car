      ...
      <DialogContent className="max-w-md sm:max-w-lg border-primary/30 bg-card/95 backdrop-blur-md max-h-[85dvh] overflow-y-auto p-4 sm:p-6">
        ...
        <div className="space-y-4 text-xs sm:text-sm">
          ...
          <Section title="GEARS (Face Buttons)">
            <Row label="A" desc="Gear 1 — 75 RPM max" badge="1" badgeColor="text-green-400 border-green-500/40" />
            <Row label="B" desc="Gear 2 — 120 RPM max" badge="2" badgeColor="text-yellow-400 border-yellow-500/40" />
            <Row label="X" desc="Gear 3 — 200 RPM max" badge="3" badgeColor="text-orange-400 border-orange-500/40" />
            <Row label="Y" desc="Gear 4 — 300 RPM max" badge="4" badgeColor="text-red-400 border-red-500/40" />
          </Section>
