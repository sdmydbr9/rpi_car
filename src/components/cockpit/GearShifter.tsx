  ...
  return (
    <div className="flex flex-col items-center h-full pt-0.5 pb-0.5 px-1 overflow-hidden bg-gradient-to-b from-background to-background/80">
      ...
      <div className="flex w-full gap-1 mb-0.5 justify-center items-center flex-shrink-0">
        ...
        >
          <svg className="w-[clamp(24px,4.8vw,36px)] h-[clamp(24px,4.8vw,36px)]" style={{ color: (!isEngineRunning || isAutopilotEnabled) ? 'rgb(107, 114, 128)' : (isIREnabled ? 'rgb(20, 184, 166)' : 'rgb(107, 114, 128)') }} viewBox="-5.0 -10.0 110.0 135.0">
        ...
        >
          <svg className="w-[clamp(24px,4.8vw,36px)] h-[clamp(24px,4.8vw,36px)]" style={{ color: (!isEngineRunning || isAutopilotEnabled) ? 'rgb(107, 114, 128)' : (isSonarEnabled ? 'rgb(20, 184, 166)' : 'rgb(107, 114, 128)') }} viewBox="-5.0 -10.0 110.0 135.0">
