...
Supports three log formats produced by motor_test.py:
  1. rpm_lock_log_*.csv  - Independent RPM-LOCK PI control
  2. sync_4wd_log_*.csv  - Sync PI control (master/slave, legacy 4WD era)
  3. legacy 2WD sync     - Rear-only sync logs (current Ackermann chassis)
...
# Columns: time_sec, target_rpm, rl_rpm, rr_rpm,
#          rl_pwm, rr_pwm
# ---------------------------------------------------------------------------
