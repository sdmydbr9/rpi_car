# 🏈️ Raspberry Pi Ackermann Rover Control System

A sophisticated autonomous and manual control system for a Raspberry Pi-powered rover built on a Hiwonder Ackermann metal chassis, with real-time telemetry, computer vision, and a modern web interface.
...
- **VL53L0X Laser**: ToF distance sensor (on camera pan/tilt gimbal)
...
- L298N Motor Driver (rear 2WD)
- HC-SR04 Ultrasonic Sensor (x1)
- VL53L0X Laser ToF Sensor
- Pan/Tilt Gimbal (camera + laser)
- Encoder Geared Motors (x2, rear drive)
- LD-1501MG Ackermann Steering Servo
- Pi Camera or USB Camera
- Hiwonder Ackermann Metal Chassis (solid rubber tyres x4)
...
- **Hardware**: Raspberry Pi + L298N Motor Driver + Hiwonder Ackermann Metal Chassis
